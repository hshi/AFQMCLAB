...
TEST(HubbardSOCMeasureSDSDTest, energy)
{
    ...
    HubbardSOCMeasureObserveSDSD hubbardSOCMeasureSDSD(hubbard);
    hubbardSOCMeasureSDSD.addMeasurement( sdsdOperation, 1.0 );
    complex<double> Henergy = hubbardSOCMeasureSDSD.returnEnergy();
