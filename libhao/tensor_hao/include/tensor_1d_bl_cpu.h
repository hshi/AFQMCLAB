...
namespace tensor_hao
{
    ...
    std::complex<double> normBlas_cpu(const TensorCore<std::complex<double>, 1> &x, size_t incx = 1);

    void scalBlas_cpu(std::complex<double> a, TensorCore<std::complex<double>, 1> &x, size_t incx = 1);
