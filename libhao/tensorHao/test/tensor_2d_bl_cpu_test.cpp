...
TEST ( Tensor_2d_bl_cpu, gmm_float)
{
...
TEST ( Tensor_2d_bl_cpu, gmm_double)
{
...
TEST ( Tensor_2d_bl_cpu, gmm_complex_float)
{
...
TEST ( Tensor_2d_bl_cpu, gmm_complex_double)
{
...
TEST ( Tensor_2d_bl_cpu, eigen_double)
{
...
TEST ( Tensor_2d_bl_cpu, eigen_complex_double )
{
...
TEST ( Tensor_2d_bl_cpu, LUconstruct )
{
...
{
    const size_t L0=3; const size_t L1=2;
    ...
    det_list_M=1.0; for(size_t i=0; i<L1; i++) det_list_M*=det_list(i);
...
TEST ( Tensor_2d_bl_cpu, SVDMatrix )
{
    ...
    for(size_t i=0; i<L; i++) D_cd(i)=D(i);
