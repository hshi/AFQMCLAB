...
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    if(USE_OPENMP)
        set(mkl_flags "-fopenmp ${mkl_flags}")
        set(sequential_name mkl_intel_thread)
        message("-- WARNING!!! In my Mac, Clang does not support openmp! Recommend to use Intel compiler!")
    else()
        set(sequential_name mkl_sequential)
    endif()
else()
    message(FATAL_ERROR "Do not recognize the cxx compiler: ${CMAKE_CXX_COMPILER_ID}")
endif()
